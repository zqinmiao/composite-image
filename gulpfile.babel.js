...
//image 压缩图片
gulp.task('image', () => gulp.src('./src/assets/images/**/*')
    .pipe(imagemin({
...
//build
gulp.task('build', (cb) => sequence('copy', 'postcss', 'uglifyjs','rev','postejs', cb));

//default
gulp.task('default', (cb) => sequence('clean','image', 'build', cb));
